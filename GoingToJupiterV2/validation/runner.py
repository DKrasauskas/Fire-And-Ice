...
from GoingToJupiterV2.validation.main_calc_validation import run_sim
import numpy as np
...
# legs_tof_lb = np.array([20,300,500])
...
# transfer_body_order = ["Earth","Venus", "Earth","Venus","Earth", "Jupiter"]
