...
# params = Ephemeris(
#     (
#         18859035560.264233,# - 100000000,
#         0.98804852543645449,
#         np.deg2rad(89.900551367034282),
#         np.deg2rad(86.444023939868416),
#         np.deg2rad(106.37893435189432),# - np.deg2rad(0.6),
#         6.2809071433766599
#     )
# )
# set_spacecraft_ephemeris(params)
# plot(ax_north, ax_south, False)
...
# params = Ephemeris(
#     (
#         18859035560.264233+ 80000000,
#         0.98804852543645449,
#         np.deg2rad(87.900551367034282),
#         np.deg2rad(86.444023939868416),
#         np.deg2rad(106.37893435189432) - np.deg2rad(0.4),
#         6.2809071433766599
#     )
# )
# set_spacecraft_ephemeris(params)
