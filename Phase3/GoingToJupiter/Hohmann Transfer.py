...
# Arrival orbit
arrival_semi_major_axis = 54525000000
arrival_eccentricity    = 0.998
...
departure_date_ub = DateTime(2038, 12, 31).to_epoch()

# Time-of-flight bounds [days → seconds]
legs_tof_lb = np.zeros(1)
legs_tof_ub = np.zeros(1)
# Earth → Jupiter
legs_tof_lb[0] = 30 * constants.JULIAN_DAY
legs_tof_ub[0] = 1600 * constants.JULIAN_DAY
